...
YANG_FILE = TEST_DIR /'ietf-layer0-types-ext.yang'
...
opticalimp_repo = 'https://raw.githubusercontent.com/ietf-ccamp-wg/draft-ietf-ccamp-optical-impairment-topology-yang/master/'
urls = [(official_yang_repo, 'standard/ietf/RFC/ietf-network@2018-02-26.yang'),
        ...
        (opticalimp_repo, 'ietf-optical-impairment-topology.yang')]
